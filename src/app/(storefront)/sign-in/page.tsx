    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-sm">
        <div className="mb-8">
          ...
          <p className="text-sm text-chalk/50">Sign in to your MAISON account</p>
        </div>
        ...
        <p className="mt-7 text-center text-sm text-chalk/40">
          Don&apos;t have an account?{" "}
          <Link href="/sign-up" className="text-chalk hover:underline">
            Sign up
          </Link>
        </p>
      </div>
